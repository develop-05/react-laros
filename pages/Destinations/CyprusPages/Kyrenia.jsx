...
import { ReactComponent as KyreniaSvg } from '../../../svg/DestinationCyprus/map/Kyrenia.svg';
    ...
    <>
      <div className="region__container">
        ...
        <div className="region__map">
          <KyreniaSvg className="region__famagusta" />
          <div className="location__kyrenia">
            <img className="famagusta__icon" src="/images/map-pin-location.svg" alt="location" />
            <span className="location__text">Kyrenia</span>
          </div>
        </div>
          ...
          <CustomScrollbars className="" style={{ width: 300, height: 300 }}>
            <div className="tab__regions">
              ...
              <NavLink to="/destinations/kyrenia">
                <div className="tab__item">
                  <button className="active__tab-region active__tab-region--2">
                    <div className="country__view-content">
                      <div className="svg__icon"><CyprusDestination2 fill="#F5BC2E" /></div>
              ...
              <NavLink to="/destinations/nicosia">
                <div className="tab__item">
                  <button
                    className={toggleState === 3 ? "tab__country" : "tab__country"} >
                    <div className="country__view-content">
