...
import { ReactComponent as LonianSvg } from '../../../svg/GreeceSvg/lonian__islands.svg';
		...
		<>
			<div className="region__container">
				...
				<div className="region__map">
					<LonianSvg className="lonian" />
					<div className="location__lonian">
						<img className="famagusta__icon" src="/images/map-pin-location.svg" alt="location" />
						<span className="location__text">Lonian Islands</span>
					</div>
				</div>
					...
					<CustomScrollbars className="" style={{ width: 300, height: 300 }}>
						<div className="tab__regions">
							...
							<NavLink to="/destinations/lonian-islands">
								<div className="tab__item">
									<button className="active__tab-region active__tab-region--attica">
										<div className="country__view-content">
											<div className="svg__icon"><GreeceDestinationsLonian fill="#F5BC2E" /></div>
