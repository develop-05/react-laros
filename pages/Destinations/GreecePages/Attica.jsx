...
import { ReactComponent as AtticaSvg } from '../../../svg/GreeceSvg/attica.svg';
		...
		<>
			<div className="region__container">
				...
				<div className="region__map">
					<AtticaSvg className="attica" />
					<div className="location__attica">
						<img className="famagusta__icon" src="/images/map-pin-location.svg" alt="location" />
						<span className="location__text">Attica</span>
					</div>
				</div>
					...
					<CustomScrollbars className="" style={{ width: 300, height: 300 }}>
						<div className="tab__regions">
							...
							<NavLink to="/destinations/attica">
								<div className="tab__item">
									<button
										className="active__tab-region active__tab-region--attica">
										<div className="country__view-content">
											<div className="svg__icon"><GreeceDestinationsAttica fill="#F5BC2E" /></div>
