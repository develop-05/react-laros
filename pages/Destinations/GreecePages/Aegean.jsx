...
import { ReactComponent as AegeanSvg } from '../../../svg/GreeceSvg/aegean.svg';
		...
		<>
			<div className="region__container">
				...
				<div className="region__map">
					<AegeanSvg className="aegean" />
					<div className="location__aegean">
						<img className="famagusta__icon" src="/images/map-pin-location.svg" alt="location" />
						<span className="location__text">Aegean</span>
					</div>
				</div>
							...
							<NavLink to="/destinations/aegean">
								<div className="tab__item">
									<button
										...
										<div className="country__view-content">
											<div className="svg__icon"><GreeceDestinationsEagean fill="#F5BC2E" /></div>
