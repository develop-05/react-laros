...
import { ReactComponent as CycladesSvg } from '../../../svg/GreeceSvg/cyclades.svg';
		...
		<>
			<div className="region__container">
				...
				<div className="region__map">
					<CycladesSvg className="cyclades" />
					<div className="location__cyclades">
						<img className="famagusta__icon" src="/images/map-pin-location.svg" alt="location" />
						<span className="location__text">Cyclades</span>
					</div>
				</div>
							...
							<NavLink to="/destinations/cyclades">
								<div className="tab__item">
									<button className="active__tab-region active__tab-region--attica">
										<div className="country__view-content">
											<div className="svg__icon"><GreeceDestinationsCyclades fill="#F5BC2E" /></div>
