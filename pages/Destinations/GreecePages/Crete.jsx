...
import { ReactComponent as CreteSvg } from '../../../svg/GreeceSvg/crete.svg';
		...
		<>
			<div className="region__container">
				...
				<div className="region__map">
					<CreteSvg className="crete" />
					<div className="location__crete">
						<img className="famagusta__icon" src="/images/map-pin-location.svg" alt="location" />
						<span className="location__text">Crete</span>
					</div>
				</div>
							...
							<NavLink to="/destinations/crete">
								<div className="tab__item">
									<button className="active__tab-region active__tab-region--attica">
										<div className="country__view-content">
											<div className="svg__icon"><GreeceDestinationsCrete fill="#F5BC2E" /></div>
