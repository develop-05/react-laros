...
import { ReactComponent as NicosiaSvg } from '../../../svg/DestinationCyprus/map/Nicosia.svg';
        ...
        <>
            <div className="region__container">
                ...
                <div className="region__map">
                    <NicosiaSvg className="region__famagusta" />
                    <div className="location__nicosia">
                        <img className="famagusta__icon" src="/images/map-pin-location.svg" alt="location" />
                        <span className="location__text">Nicosia</span>
                    </div>
                </div>
                    ...
                    <CustomScrollbars className="" style={{ width: 300, height: 300 }}>
                        <div className="tab__regions">
                            ...
                            <NavLink to="/destinations/nicosia">
                                <div className="tab__item">
                                    <button className="active__tab-region active__tab-region--3">
                                        <div className="country__view-content">
                                            <div className="svg__icon"><CyprusDestination3 fill="#F5BC2E" /></div>
