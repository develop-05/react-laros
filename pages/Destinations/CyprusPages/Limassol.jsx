...
import { ReactComponent as LimassolSvg } from '../../../svg/DestinationCyprus/map/Limassol.svg';
      ...
      <>
        <div className="region__container">
          ...
          <div className="region__map">
            <LimassolSvg className="region__famagusta" />
            <div className="location__limassol">
              <img className="famagusta__icon" src="/images/map-pin-location.svg" alt="location" />
              <span className="location__text">Limassol</span>
            </div>
          </div>
            ...
            <CustomScrollbars className="" style={{ width: 300, height: 300 }}>
              <div className="tab__regions">
                ...
                <NavLink to="/destinations/limassol">
                  <div className="tab__item">
                    <button
                      className="active__tab-region active__tab-region--6">
                      <div className="country__view-content">
                        <div className="svg__icon"><CyprusDestination6 fill="#F5BC2E" /></div>
